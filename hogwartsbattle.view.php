 ...
 * particular, you can set here the values of variables elements defined in hogwartsbattle_hogwartsbattle.tpl (elements
 ...
 */
  ...
  class view_hogwartsbattle_hogwartsbattle extends game_view
  {
    function getGameName() {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "hogwartsbattle_hogwartsbattle", "myblock" );
