...
CREATE TABLE IF NOT EXISTS `hogwarts_card` (
...
CREATE TABLE IF NOT EXISTS `harry_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ron_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hermione_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `neville_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `villain_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dark_arts_card` (
  `card_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `card_type` varchar(16) NOT NULL,
  `card_type_arg` int(11) NOT NULL,
  `card_location` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `effect` (
  ...
  `effect_key` varchar(16) NOT NULL,
  `effect_trigger` varchar(32) NOT NULL,
...
ALTER TABLE `player` ADD `player_discards` INT NOT NULL DEFAULT '0';
ALTER TABLE `player` ADD `player_stunned` BOOLEAN NOT NULL DEFAULT false;
